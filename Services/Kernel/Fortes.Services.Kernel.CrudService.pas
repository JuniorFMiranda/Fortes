...
function TCrudService<TCrud>.GetGridSource: TDataSource;
begin
  Result := FFormService.GetForm.GridSource;
end;
...
procedure TCrudService<TCrud>.OneToMany(AMasterCrud: TBaseCrudForm;
  ADetailFieldName: string);
begin
  FFormService.GetForm.MasterCrud := AMasterCrud;
  FFormService.GetForm.DetailFieldName := ADetailFieldName;
end;
