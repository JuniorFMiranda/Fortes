...
type
  TAbastecimentoItemForm = class(TBaseCrudForm)
    tbDefaultID_ABASTECIMENTO_ITEM: TIntegerField;
    tbDefaultID_ABASTECIMENTO: TIntegerField;
    tbDefaultID_COMBUSTIVEL: TIntegerField;
    tbDefaultQUANTIDADE: TBCDField;
    tbDefaultVALOR_ICMS: TBCDField;
    tbDefaultVALOR: TBCDField;
    tbDefaultTOTAL: TBCDField;
    tbDefaultDESCRICAO: TStringField;
    tbDefaultPERCENTUAL_ICMS: TBCDField;
  private
